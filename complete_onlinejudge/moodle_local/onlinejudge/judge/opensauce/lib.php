...
class judge_opensauce extends judge_base {
	...
	$languages_json = file_get_contents($CFG->dirroot . "/local/onlinejudge/judge/opensauce/languages.json");
	...
	// Begin soap
         ...
         * @param run determines whether the source code should be executed.
         * @param private determines whether the paste should be private.
